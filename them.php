...
// Võ Xuân An - version 1.3 - chức năng xóa bài viết 
<?php
    $sqli = new mysqli(SERVER, USER, PASS, DB);
    mysqli_query($sqli,"SET NAMES 'UTF8'");
    ?>
...
//CuongDao - version 1.1 - thêm chức năng sửa bài viết
<?php
    $sqli = new mysqli(SERVER, USER, PASS, DB);
    mysqli_query($sqli,"SET NAMES 'UTF8'");
    ?>
...
//CHITAM ---VERSION 1.2 ---THÊM CHỨC NĂNG TÌM KIẾM
...
<table width="423" height="212" border="0">
  <tr>
    <td colspan="3"><div align="center">CHỨC NĂNG TÌM KIẾM CHUYÊN MỤC</div></td>
  </tr>
  <tr>
    <td width="211">Tên Chuyên Mục :</td>
    <td colspan="2"><input type="text" name="tenchuyenmuc" id="tenchuyenmuc"></td>
